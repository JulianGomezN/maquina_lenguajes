...
class SimuladorGUI:
    ...
    def _columna_codigo_relocalizable(self, parent):
        ...
        ttk.Label(parent, text="Código Relocalizable", font=("Arial", 13, "bold")).pack()
        ...
        ttk.Button(parent, text="Enlazar y Cargar", command=self.enlazar_y_cargar).pack(fill="x", pady=10)
